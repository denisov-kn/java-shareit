...
public class BookingService {
    ...
    public List<BookingDto> findAllBookingsByUserIdAndState(Long userId, String state) {
    ...
    public List<BookingDto> findAllBookingsByOwnerIdAndState(Long ownerId, String state) {
